      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-700 dark:text-white/90 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          >
            <div className="glass-card p-6 rounded-2xl">
              ...
              <div className="text-gray-700 dark:text-white/80">Students</div>
            </div>
            <div className="glass-card p-6 rounded-2xl">
              <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">50+</div>
              <div className="text-gray-700 dark:text-white/80">Expert Teachers</div>
            </div>
            <div className="glass-card p-6 rounded-2xl">
              <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">15+</div>
              <div className="text-gray-700 dark:text-white/80">Years of Excellence</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
