    ...
    <section ref={ref} className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-700 dark:text-white/90 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {highlights.map((highlight, index) => (
            ...
            >
              {/* Icon Element */}
              <div className={`w-14 h-14 bg-gradient-to-br ${highlight.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl border-2 border-white/20`}>
                <span className="text-white text-2xl drop-shadow-lg font-bold">{highlight.lightElement}</span>
              </div>
        ...
        >
          <div className="glass-card p-8 rounded-3xl max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              {/* Light Theme Element */}
              <div className="w-8 h-8 bg-yellow-100 border-2 border-yellow-200 rounded-lg flex items-center justify-center mr-3 text-yellow-700 text-lg">
                ⚡
              </div>
              {/* Dark Theme Element */}
              <div className="w-8 h-8 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center mr-3 text-white text-lg dark:flex hidden">
                ⚡
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Ready to Join Our Community?</h3>
            </div>
            <p className="text-gray-700 dark:text-white/90 text-lg mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <button className="glass text-gray-900 dark:text-white px-8 py-3 rounded-full font-semibold hover:bg-gray-200/30 dark:hover:bg-white/20 transition-all duration-300">
                Download Brochure
              </button>
            </div>
          </div>
