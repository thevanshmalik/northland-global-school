      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-white font-medium">CBSE Affiliated School</span>
          </motion.div>
          ...
          >
            ...
            <button className="group glass-card text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white/20 transition-all duration-300 flex items-center space-x-2">
          ...
          >
            ...
            <div className="glass-card p-6 rounded-2xl">
              ...
              <div className="text-white/70">Expert Teachers</div>
            </div>
            <div className="glass-card p-6 rounded-2xl">
