      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-gray-800 dark:text-white font-medium">CBSE Affiliated School</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-800 dark:text-white leading-tight"
          >
            Nurturing Future
            <br />
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-600 dark:text-white/90 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          >
            ...
            <button className="group glass-card text-gray-800 dark:text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-200/30 dark:hover:bg-white/20 transition-all duration-300 flex items-center space-x-2">
          ...
          >
            <div className="glass-card p-6 rounded-2xl">
              ...
              <div className="text-gray-600 dark:text-white/80">Students</div>
            </div>
            <div className="glass-card p-6 rounded-2xl">
              <div className="text-3xl font-bold text-gray-800 dark:text-white mb-2">50+</div>
              <div className="text-gray-600 dark:text-white/80">Expert Teachers</div>
            </div>
            <div className="glass-card p-6 rounded-2xl">
              <div className="text-3xl font-bold text-gray-800 dark:text-white mb-2">15+</div>
              <div className="text-gray-600 dark:text-white/80">Years of Excellence</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
