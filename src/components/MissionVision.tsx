  ...
  return (
    <section ref={ref} className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {cards.map((card, index) => (
            ...
            >
              ...
              <p className="text-gray-600 dark:text-white/90 leading-relaxed text-lg">
                {card.content}
              </p>
            </motion.div>
          ))}
        ...
        >
          <h3 className="text-3xl font-bold text-gray-800 dark:text-white mb-8">Our Core Values</h3>
